        ...
        {rows.map((r, index) => {
          ...
          return (
            <div
              ...
              className={`relative min-h-[118px] overflow-hidden rounded-2xl border p-3 ${
                isTop
            ...
            >
              ...
              <div className="relative flex items-start justify-between gap-2">
                ...
                <div className="text-right">
                  <p className="text-xl font-black text-turquoise">{formatNumber(r.dentists)}</p>
                  <p className="text-[9px] font-bold uppercase tracking-wide text-muted-foreground">dentistes</p>
                </div>
              </div>
              <p className="relative mt-3 line-clamp-1 text-sm font-black text-navy">{r.locality}</p>
              <p className="relative mt-1 inline-flex max-w-full items-center gap-1 text-[11px] font-semibold text-muted-foreground">
                ...
                <span className="truncate">{r.governorate || "A verifier"}</span>
              </p>
